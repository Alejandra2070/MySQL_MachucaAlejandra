...
CREATE TABLE gama_producto(
    ...
    description_texto TEXT NOT NULL,
...
INSERT INTO cliente VALUES (1, 'GoldFish Garden', 'Daniel G', 'GoldFish', '5556901745', '5556901746', 'False Street 52 2 A', '', 'San Francisco', NULL, 'USA', '24006', 3000);
...
INSERT INTO cliente VALUES (35, 'Tutifruti S.A', 'Jacob', 'Jones', '2 9261-2433', '2 9283-1695', 'Level 24, St. Martins Tower.-31 Market St.', '', 'Sydney', 'Nueva Gales del Sur', 'Australia', '2000', 10000);
INSERT INTO cliente VALUES (36, 'Café de Flore', 'Céline', 'Dupont', '(33)0141741025', '(33)0141741026', '172 Boulevard Saint-Germain', '', 'Paris', 'Île-de-France', 'France', '75006', 20000);
INSERT INTO cliente VALUES (37, 'Jardins de Monet', 'Monet', 'Claude', '(33)0145220811', '(33)0145220812', 'C/Normandy', '', 'Giverny', 'Normandy', 'France', '27620', 15000);
INSERT INTO cliente VALUES (38, 'El Jardin Viviente S.L', 'Justin', 'Smith', '2 8005-7161', '2 8005-7162', '176 Cumberland Street The Rocks', '', 'Sydney', 'Nueva Gales del Sur', 'Australia', '2003', 8000);
...
SELECT puesto,nombre,apellido1,apellido2,email FROM empleado WHERE codigo_jefe = 1;-- Devuelve el nombre del puesto, nombre, apellidos y email del jefe de la empresa. -- Arreglaaar!!
...
SELECT DISTINCT codigo_cliente FROM pedido WHERE YEAR(fecha_pedido) = 2008 AND estado = 'Pagado'; -- Utilizando la función YEAR de MySQL. -- Arreglaaar!!
SELECT codigo_pedido,codigo_cliente,fecha_esperada,fecha_entrega FROM pedido WHERE fecha_entrega > fecha_esperada OR fecha_entrega IS NULL; -- Devuelve un listado con el código de pedido, código de cliente, fecha esperada y fecha de entrega de los pedidos que no han sido entregados a tiempo.
...
SELECT * FROM pedido WHERE YEAR(fecha_pedido) = 2009; -- Devuelve un listado de todos los pedidos que fueron en 2009.
SELECT * FROM pedido WHERE MONTH(fecha_pedido) = 1; -- Devuelve un listado de todos los pedidos que han sido  en el mes de enero de cualquier año.
SELECT * FROM pago WHERE YEAR(fecha_pago) = 2008 AND forma_pago = 'PayPal' ORDER BY total DESC; -- Devuelve un listado con todos los pagos que se realizaron en el año 2008 mediante Paypal. Ordene el resultado de mayor a menor.
